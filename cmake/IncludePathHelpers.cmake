...
# Populate the input variable with a string/list with the platform specific includes.
# Example:
#     get_platform_specific_includes(VARIABLE my_includes)
...
function(get_platform_specific_includes)
  ...
  # We are using the standard library shipped with the downloaded llvm for include paths in the parsing
  ...
  set(${ARG_VARIABLE} ${platform_include} PARENT_SCOPE)
endfunction()

# Format the INCLUDES
# Example:
#     format_includes(VARIABLE my_formated_includes INCLUDES my_includes)
#     message(STATUS "${my_includes}")
#       --- /usr/include;/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include
#     message(STATUS "${my_formated_includes}")
#       --- "-I/usr/include", "-I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include"
#     NOTE: If you want system includes (-isystem) use the SYSTEM flag
function(format_includes)
  ...
  endforeach()
  set(${ARG_VARIABLE} ${temp} PARENT_SCOPE)
endfunction()

# Tests:
# format_includes(VARIABLE
#                 bla
#                 INCLUDES
#                 "Hi;Ho")
# message(STATUS ${bla})

# get_platform_specific_includes(VARIABLE includes)
