...
macro(set_clang_windows_version_resource_properties name)
  if(DEFINED windows_resource_file)
    set_windows_version_resource_properties(
      ...
      VERSION_STRING
      "${CLANG_VERSION} (${BACKEND_PACKAGE_STRING})"
      PRODUCT_NAME
      "clang")
  endif()
endmacro()
...
macro(add_clang_library name)
  cmake_parse_arguments(ARG "SHARED;INSTALL_WITH_TOOLCHAIN" ""
                        "ADDITIONAL_HEADERS" ${ARGN})
  set(srcs)
  if(MSVC_IDE OR XCODE)
    # Add public headers
    file(RELATIVE_PATH lib_path ${CLANG_SOURCE_DIR}/lib/
    ...
    if(NOT lib_path MATCHES "^[.][.]")
      ...
      file(GLOB_RECURSE tds ${CLANG_SOURCE_DIR}/include/clang/${lib_path}/*.td)
  ...
  if(srcs OR ARG_ADDITIONAL_HEADERS)
    set(srcs ADDITIONAL_HEADERS ${srcs}
  ...
  if(TARGET ${name})
    ...
    if(NOT LLVM_INSTALL_TOOLCHAIN_ONLY OR ARG_INSTALL_WITH_TOOLCHAIN)
      ...
      install(
        TARGETS ${name} COMPONENT ${name} ${export_to_clangtargets}
        LIBRARY DESTINATION lib${LLVM_LIBDIR_SUFFIX}
        ARCHIVE DESTINATION lib${LLVM_LIBDIR_SUFFIX}
        RUNTIME DESTINATION bin)

      if(NOT LLVM_ENABLE_IDE)
        add_llvm_install_targets(install-${name} DEPENDS ${name} COMPONENT
                                 ${name})
      endif()
...
macro(add_clang_tool name)
  ...
  if(CLANG_BUILD_TOOLS)
    ...
    install(TARGETS ${name} ${export_to_clangtargets} RUNTIME DESTINATION bin
                                                              COMPONENT ${name})
