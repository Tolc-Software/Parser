...
static constexpr auto vector_pattern =
    ctll::fixed_string {"class std(::__1)?::vector<.*>"};
...
static constexpr auto array_pattern =
    ctll::fixed_string {"struct std(::__1)?::array<.*>"};
...
static constexpr auto map_pattern =
    ctll::fixed_string {"class std(::__1)?::map<.*>"};
...
static constexpr auto unordered_map_pattern =
    ctll::fixed_string {"class std(::__1)?::unordered_map<.*>"};
...
static constexpr auto set_pattern =
    ctll::fixed_string {"class std(::__1)?::set<.*>"};
...
static constexpr auto unordered_set_pattern =
    ctll::fixed_string {"class std(::__1)?::unordered_set<.*>"};
...
static constexpr auto allocator_pattern =
    ctll::fixed_string {"class std(::__1)?::allocator<.*>"};
...
static constexpr auto tuple_pattern =
    ctll::fixed_string {"class std(::__1)?::tuple<.*>"};
